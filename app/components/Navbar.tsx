      ...
      >
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            <Link href="/" className="press flex items-center gap-3 group shrink-0">
              <div className="relative w-11 h-11 rounded-full overflow-hidden border border-gold/30 group-hover:border-gold/60 transition-colors duration-300">
            ...
            <div className="flex items-center gap-6 lg:gap-8">
              <div ref={navRef} className="relative hidden lg:flex items-center gap-1">
                {navLinks.map((link) => (
                  <a
                    ...
                    href={link.href}
                    className={`group/link relative px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 active:scale-[0.98] outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold/60 focus-visible:outline-offset-2 ${
                ...
                {indicator && (
                <span
                  className="absolute -bottom-0.5 h-px bg-gold shadow-[0_0_6px_rgba(212,175,55,0.5)] transition-[left,width] duration-300 ease-drawer"
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="press hidden sm:inline-flex items-center gap-2.5 px-5 py-2.5 rounded-md bg-gold text-pp-black font-bold text-xs sm:text-sm tracking-wide uppercase hover:bg-gold-light shadow-[0_0_20px_rgba(212,175,55,0.2)] hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold/60 focus-visible:outline-offset-2"
              >
                Book a Table
              </a>
              ...
              <button
                ...
                className="tap lg:hidden w-10 h-10 rounded-md bg-pp-card border border-gold/15 flex items-center justify-center hover:bg-pp-hover outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold/60 focus-visible:outline-offset-2"
        ...
        >
          <div className="flex items-center justify-between px-6 h-16 sm:h-20 border-b border-gold/10">
            ...
            <button
              ...
              className="tap w-10 h-10 rounded-md bg-pp-card border border-gold/15 flex items-center justify-center hover:bg-pp-hover outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold/60 focus-visible:outline-offset-2"
          ...
          <div className="px-8 sm:px-12 lg:px-16 pb-10">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="press group flex items-center justify-center gap-3 py-4 rounded-md bg-gold text-pp-black font-bold uppercase tracking-wider text-sm shadow-[0_0_25px_rgba(212,175,55,0.2)] hover:shadow-[0_0_40px_rgba(212,175,55,0.35)] outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold/60 focus-visible:outline-offset-2"
              >
